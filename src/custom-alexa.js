...
function ResponseBuilder(self) {
    ...
    return (function () {
        return {
            ...
            'videoPlayer': function (url, title, subtitle) {
                const videoPlayerDirective = {
                ...
                responseObject.response.directives = [videoPlayerDirective];
                delete responseObject.response.shouldEndSession;
                return this;
            },
            'displayBodyTemplate2': function (token, isBackButtonVisible, title, image, primaryText, secondaryText) {
                var renderTemplateDirective = {
                    "type": "Display.RenderTemplate",
                    "template": {
                        "type": "BodyTemplate2",
                        "token": token,
                        "backButton": isBackButtonVisible ? "VISIBLE" : "HIDDEN",
                        "title": title,
                        "image": {
                ...
                responseObject.response.directives = [renderTemplateDirective];
                return this;
            },
            'displayListTemplate2': function (isBackButtonVisible, title, listItems) {
                var renderTemplateDirective = {
                    "type": "Display.RenderTemplate",
                    "template": {
                        "type": "ListTemplate2",
            ...
            'displayListTemplate1': function (isBackButtonVisible, title, listItems) {
                var renderTemplateDirective = {
                    "type": "Display.RenderTemplate",
                    "template": {
                        "type": "ListTemplate1",
